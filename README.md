...
## 🚀 프로젝트 개요
**CertFinder**는 대한민국 600여 종의 국가 기술 및 전문 자격증 데이터를 실시간으로 분석하여 사용자에게 최적의 커리어 로드맵을 제시하는 지능형 플랫폼입니다. 단순 조회를 넘어 합격률 추이, 취업 전망, 그리고 AI 기반의 직무 매칭 서비스를 통해 데이터 기반의 자기계발을 지원합니다.
...
*   **Supabase Auth**: 보안이 강화된 사용자 인증 및 프로필 관리.
