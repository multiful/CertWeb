...
class Qualification(Base):
    ...
    # ncs_mapping1.csv 조인 결과 (canonical RAG_CANONICAL_NCS_CSV 시 dense/BM25에 반영)
    ncs_large_mapped = Column(String(200), nullable=True)
    ncs_mid = Column(String(200), nullable=True)
